const polkadotTypes = (function (exports, util, utilCrypto) {
  ...
  function getModuleTypes({
    ...
    return util.objectSpread({}, typesModules$1[section], (_knownTypes$typesAlia = knownTypes.typesAlias) === null || _knownTypes$typesAlia === void 0 ? void 0 : _knownTypes$typesAlia[section]);
  }
  ...
  const definitions$9 = {
    rpc: {},
    types: util.objectSpread({}, layout, spec, {
      ContractProjectInfo,
      ContractMetadataV0,
      ContractMetadataV1,
      ContractMetadata: {
  ...
  function decodeU8a$3(registry, u8a, types, withZip) {
  ...
  */
  ...
  function decodeEnum(registry, def, value, index) {
    ...
    if (util.isNumber(index)) {
      ...
      const u8a = util.u8aToU8a(value); // nested, we don't want to match isObject below
  ...
  var _Types$1 = /*#__PURE__*/_classPrivateFieldKey("Types");

  class Struct extends Map {
    constructor(registry, Types, value, jsonMap = new Map()) {
      const typeMap = mapToTypeMap(registry, Types);
      const [decoded, decodedLength] = util.isU8a(value) ? decodeU8a$3(registry, value, typeMap, true) : util.isHex(value) ? decodeU8a$3(registry, util.u8aToU8a(value), typeMap, true) : value instanceof Struct ? [value, 0] : decodeStructFromObject(registry, typeMap, value || {}, jsonMap);
      super(decoded);
      this.registry = void 0;
      this.createdAtHash = void 0;
      this.initialU8aLength = void 0;
      ...
      _classPrivateFieldBase(this, _Types$1)[_Types$1] = typeMap;
    }
    ...
    get defKeys() {
      return Object.keys(_classPrivateFieldBase(this, _Types$1)[_Types$1]);
    }
    /**
     * @description Checks if the value is an empty value
     */
    ...
    get Type() {
      const result = {};
      const defs = Object.entries(_classPrivateFieldBase(this, _Types$1)[_Types$1]);
    ...
    toRawType() {
      return util.stringify(typesToMap(this.registry, _classPrivateFieldBase(this, _Types$1)[_Types$1]));
    }
    /**
     * @description Returns the string representation of the value
     */
  ...
  class Option {
    constructor(registry, typeName, value) {
      ...
      this.registry = registry;
      _classPrivateFieldBase(this, _Type$2)[_Type$2] = Type;
  ...
  function decodeTuple(registry, Classes, value) {
    if (util.isU8a(value) || util.isHex(value)) {
      return decodeU8a$3(registry, util.u8aToU8a(value), Classes);
    }
  ...
  class Tuple extends AbstractArray {
    constructor(registry, Types, value) {
      ...
      const [values, decodedLength] = util.isU8a(value) ? decodeU8a$3(registry, value, Classes) : decodeTuple(registry, Classes, value);
      super(registry, values, decodedLength);
      Object.defineProperty(this, _Types, {
        writable: true,
        value: void 0
      });
      _classPrivateFieldBase(this, _Types)[_Types] = Classes;
    }
    ...
    get Types() {
      return Array.isArray(_classPrivateFieldBase(this, _Types)[_Types]) ? _classPrivateFieldBase(this, _Types)[_Types].map(T => new T(this.registry).toRawType()) : Object.keys(_classPrivateFieldBase(this, _Types)[_Types]);
    }
    /**
     * @description Returns the base runtime type name for this instance
     */
    ...
    toRawType() {
      const types = (Array.isArray(_classPrivateFieldBase(this, _Types)[_Types]) ? _classPrivateFieldBase(this, _Types)[_Types] : Object.values(_classPrivateFieldBase(this, _Types)[_Types])).map(T => this.registry.getClassName(T) || new T(this.registry).toRawType());
      return `(${types.join(',')})`;
    }
    /**
     * @description Returns the string representation of the value
  ...
  const allExtensions = util.objectSpread({}, substrate$1, polkadot, shell, statemint); // the v4 signed extensions prior to the point of exposing these to the
  ...
  var _hashCache = /*#__PURE__*/_classPrivateFieldKey("hashCache");
  ...
  var _signKeys = /*#__PURE__*/_classPrivateFieldKey("signKeys");
  ...
  class GenericExtrinsicSignatureV4 extends Struct {
    constructor(registry, value, {
      ...
      super(registry, util.objectSpread( // eslint-disable-next-line sort-keys
      {
        signer: 'Address',
  ...
  function decodeMetadata(registry, _value) {
    if (util.isU8a(_value) || !_value || util.isHex(_value)) {
  ...
  function objectNameFirstLower({
    ...
    return util.stringLowerFirst(name);
  }
  function objectNameToCamel({
    name
  }) {
    return util.stringCamelCase(name);
  }
  ...
  function createCallFunction(registry, lookup, variant, sectionName, sectionIndex) {
    ...
    return createUnchecked(registry, sectionName, new Uint8Array([sectionIndex, index.toNumber()]), registry.createType('FunctionMetadataLatest', util.objectSpread({
      args
    }, variant)));
  }
  /** @internal */
  ...
  function createFunction(registry, itemFn, options) {
    ...
    const storageFn = expandWithMeta(itemFn, (...args) => {
      if (type.isPlain) {
        if (!cacheKey) {
          cacheKey = options.skipHashing ? util.compactAddLength(util.u8aToU8a(options.key)) : createKey(registry, itemFn, [], [], []);
        }
  ...
  var _metadataVersion = /*#__PURE__*/_classPrivateFieldKey("metadataVersion");
  ...
  class TypeRegistry {
    ...
    setMetadata(metadata, signedExtensions, userExtensions) {
      ...
      injectEvents(this, _classPrivateFieldBase(this, _metadata)[_metadata], _classPrivateFieldBase(this, _metadataVersion)[_metadataVersion], _classPrivateFieldBase(this, _metadataEvents)[_metadataEvents]); // setup the available extensions
