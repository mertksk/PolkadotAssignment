...
const _0n = (0, _utils._n)(0);

const _1n = (0, _utils._n)(1);

const _2n = (0, _utils._n)(2);

const _7n = (0, _utils._n)(7);

const _256n = (0, _utils._n)(256);

const _0x71n = (0, _utils._n)(0x71); // Various per round constants calculations
...
for (let round = 0, R = _1n, x = 1, y = 0; round < 24; round++) {
  ...
  for (let j = 0; j < 7; j++) {
    ...
    if (R & _2n) t ^= _1n << (_1n << (0, _utils._n)(j)) - _1n;
  }
